...
<body>
    <div class="container">
        <h1>Aktivitas dino ngaban🚀</h1>
        <form name="Aktivitas-dino ngaban" action="#" method="post">
            <input type="text" placeholder="Buat Kegiatanmu dino ngaban..." name="tugas" value="<?php echo isset($_SESSION['edit_index']) ? htmlspecialchars($_SESSION['tugas'][$_SESSION['edit_index']]['nama']) : ''; ?>" required>
